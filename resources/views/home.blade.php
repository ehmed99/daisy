                                    ...
                                    <div id="carousel_2" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <div class="media">
                                                    <img src="{{ asset('/images/products/img-2.png') }}" height="200" class="mr-4" alt="...">
                                            ...
                                            <div class="carousel-item">
                                                <div class="media">
                                                    <img src="{{ asset('/images/products/img-3.png') }}" height="200" class="mr-4" alt="...">
                                                    <div class="media-body align-self-center"> 
                                            ...
                                            <div class="carousel-item">
                                                <div class="media">
                                                    <img src="{{ asset('/images/products/img-1.png') }}" height="200" class="mr-4" alt="...">
                                                    <div class="media-body align-self-center"> 
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img class="" src="{{ asset('/images/products/img-1.png') }}" alt="user"> </td>
                                                    <td>
                                                        Beg
                                                    </td>
                                                    <td>                                                                
                                                        <img src="{{ asset('/images/flags/us_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img class="" src="{{ asset('/images/products/img-2.png') }}" alt="user"> </td>
                                                    <td>
                                                        Watch
                                                    </td>
                                                    <td>                                                                
                                                        <img src="{{ asset('/images/flags/french_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img class="" src="{{ asset('/images/products/img-3.png') }}" alt="user"> </td>
                                                    <td>
                                                        Headphone
                                                    </td>
                                                    <td>                                                                
                                                        <img src="{{ asset('/images/flags/spain_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img class="" src="{{ asset('/images/products/img-4.png') }}" alt="user"> </td>
                                                    <td>
                                                        Purse
                                                    </td>
                                                    <td>                                                                
                                                        <img src="{{ asset('/images/flags/russia_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img class="" src="{{ asset('/images/products/img-5.png') }}" alt="user"> </td>
                                                    <td>
                                                        Shoe
                                                    </td>
                                                    <td>                                                                
                                                        <img src="{{ asset('/images/flags/italy_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img class="" src="{{ asset('/images/products/img-6.png') }}" alt="user"> </td>
                                                    <td>
                                                        Boll
                                                    </td>
                                                    <td>                                                                
