      <!-- sidebar -->
          <div class="col-2 sidebar ">
                <a href="#" class="navbar-brand text-white d-block mx-auto text-center py-3 mb-4 bottom-border">Dasiy Water</a>
                <ul class="navbar-nav flex-column mt-4">
                  ...
                  <li class="nav-item"><a href="{{route('employ.index')}}" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-user text-light fa-lg mr-3"></i>Employ</a></li>
                  <li class="nav-item"><a href="{{route('client.index')}}" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-address-card-o text-light fa-lg mr-3"></i>Customer</a></li>
