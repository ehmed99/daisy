...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <button onclick="window.open('C:/Users/HP/Desktop/DasiyWater/ecommerce/customerform.html','_blank')"  class="btn btn-primary px-4 float-right mt-0 mb-3"><i class="mdi mdi-plus-circle-outline mr-2"></i>Add New Customer</button>
                    ...
                    <div class="table-responsive dash-social">
                        <table id="datatable" class="table">
                            ...
                            <th scope="row">{{ $no }}</th>
                                ...
                                <td>{{ $client->qty }}</td>
                                <td class="row">
                                    <a href="client/{{ $client->id }}/edit" class="fas fa-edit text-info font-16"> Edit</a>
                                    <form action="{{ route('client.destroy',$client->id) }}" method="POST" style="margin-left: auto">
                                        @csrf
                                            @method('delete')
                                            <button type="submit" class="fas fa-trash-alt text-danger font-16">Delete</button>
                                    </form>
                            </td>
                            {{$no++}}    
                            @endforeach                        
