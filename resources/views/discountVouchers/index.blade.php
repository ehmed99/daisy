        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <button onclick="window.open('./create')"  class="btn btn-primary px-4 float-right mt-0 mb-3"><i class="mdi mdi-plus-circle-outline mr-2"></i>Add Voucher</button>
                            ...
                            <div class="table-responsive dash-social">
                                <table id="datatable" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $discountVourcher->vourcher_name }}<small class="badge badge-soft-pink ml-1">New</small></td>
                                        <td>{{ $discountVourcher->product_name }}</td>
